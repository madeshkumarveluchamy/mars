    ...
    <section className="faq-sections bg-black text-white py-5" data-bg="black">
      <div className="container-xxl py-5">
        ...
        <div className="faq-list mt-5">
          {faqs.map((faq, index) => (
            <div key={index} className="faq-rows py-4 px-3 border-bottom border-secondary">
              <div className="row align-items-center text-center text-lg-start py-1 py-lg-2">
                {/* Number */}
                <div className="col-md-1">
                  <span className="faq-numbers fw-bold ">{faq.id}</span>
                </div>
                {/* Question */}
                <div className="col-md-5">
                  <h6 className="faq-questions fw-bold mb-0 text-uppercase">{faq.question}</h6>
                </div>
                {/* Answer */}
                <div className="col-md-5">
                  <p className="faq-answers small mb-0">{faq.answer}</p>
                </div>
                {/* Arrow Icon */}
